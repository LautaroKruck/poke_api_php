...
<body>
    <header>
        <h1><a href="index.php">Pokédex App</a></h1>
        <nav>
            <a href="login.php">Login</a>
            <a href="register.php">Registro</a>
            <a href="pokemon.php">API</a>
        </nav>
    </header>
                ...
                if (isset($_POST['pokemon-name'])) {
                    ...
                    if (!empty($pokemonName)) {
                        ...
                        if (isset($datos_pokemon['id'])) {
                            ...
                            echo "<img style='border: 5px solid 'black' src='{$datos_pokemon['sprites']['front_default']}' alt='Imagen del Pokémon' />";
                            echo "</div>";
                        ...
                        } else echo "<p class='error'>Pokémon no encontrado. Por favor, verifica el nombre.</p>";
                    } else echo "<p class='error'>Por favor, ingresa un nombre válido.</p>";
                }
            }
            ?>
        </div>
